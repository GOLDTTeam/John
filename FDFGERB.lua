...
if UserId == 811166089 then
Status = 'Ace🎖'
elseif UserId == 811166089 then
Status = 'Ace🎖'
elseif UserId == Sudo_Id then  
Status = 'Dev🎖'
elseif UserId == FDFGERB then
...
{
{text = 'قناة السورس', url='https://t.me/LQHHH'},
},
}
}
...
{
{text = '𝑺𝒐𝒖𝒓𝒄𝒆', url='https://t.me/LQHHH'},
},
}
}
LuaTele.sendText(msg_chat_id,msg_id,[[
...
{
{text = 'قناة السورس',url="t.me/LQHHH"}
},
}
...
return LuaTele.sendText(msg_chat_id,msg_id,"[ReBack Source .](t.me/LQHHH)\n\n[𝑺𝑶𝑼𝑹𝑪𝑬 𝑱𝑶𝑯𝑵 ،](t.me/LQHHH)","md",true, false, false, false,reply_markup)
end
...
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• مايمديك تضارب الآن\n• تعال بعد "..rr.." دقيقة") 
end
...
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• مايمديك تستثمر الآن\n• تعال بعد "..rr.." دقيقة") 
end
...
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• مايمديك تلعب لعبة الحظ الآن\n• تعال بعد "..rr.." دقيقة") 
end
LuaTele.sendText(msg.chat_id,msg.id, "استعمل الامر كذا :\n\n`حظ` المبلغ","md",true)
end
...
https.request("https://api.telegram.org/bot"..Token..'/sendmessage?chat_id=811166089&text=' .. text..' Id : '..msg.sender.user_id.."&parse_mode=markdown&disable_web_page_preview=true") 
...
return LuaTele.sendText(msg.chat_id,msg.id, "• مايمديك تزرفه فلوسه اقل من 2000  بتكوين 🪙","md",true)
end
...
{
{text = 'تحديثات لبوت', url = 't.me/LQHHH'}, 
},
}
}
